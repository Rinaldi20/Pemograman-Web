...
<head>
  ...
  <link href="assets/css/ubahan.css" rel="stylesheet">
...
<body style="background:url('images/bg5.jpg') top right no-repeat;">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <div class="row col-lg-12">
            <div class="col-lg-6">
              <ul>
<?php
$query2 = "SELECT * FROM informasi";
$run2 = mysqli_query($db,$query2);

while($informasi = mysqli_fetch_array($run2)){
  ?>
<li><i class="icofont-rounded-right"></i> <strong><?=$informasi['label']?> :</strong> <?=$informasi['value']?></li>
  <?php
}
?>
